...
interface HeaderProps {
    ...
    handlePublishSurvey: () => void;
    isSubmitting: "draft" | "published" | null;
    isEdit: boolean;
}
...
interface SurveyDetailsProps {
    ...
    serviceTypes: IdNamePair[];
    coverImage: File | string | null;
    setCoverImage: (value: File | string | null) => void;
    askName: boolean;
    setAskName: (value: boolean) => void;
    askEmail: boolean;
    setAskEmail: (value: boolean) => void;
    handleSaveDraft: () => void;
    handlePublishSurvey: () => void;
    isSubmitting: "draft" | "published" | null;
}
...
const SurveyDetails = ({
    ...
    handlePublishSurvey,
    isSubmitting,
}: SurveyDetailsProps): React.JSX.Element => {
