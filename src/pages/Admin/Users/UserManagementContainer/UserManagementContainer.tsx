...
interface ButtonsContainerProps {
    ...
    manageRolesIsOpen: boolean;
    setManageRolesIsOpen: (isOpen: boolean) => void;
    permissionSettingsIsOpen: boolean;
    setPermissionSettingsIsOpen: (isOpen: boolean) => void;
...
const ButtonsContainer = ({
    ...
    hasPermission,
}: ButtonsContainerProps): React.JSX.Element => {
    return (
...
const UserManagementContainer = ({
    ...
    const [addUserIsOpen, setAddUserIsOpen] = useState<boolean>(false);
    const [manageRolesIsOpen, setManageRolesIsOpen] = useState<boolean>(false);
