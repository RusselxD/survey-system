...
const FailedToLoadComponent = ({dataName = "data", handleReloadComponent, heightAndWidth}) => {
    return (
        <div className={`custom-container ${heightAndWidth} flex flex-col items-center justify-center bg-red-100 dark:bg-red-400/30 border-2 border-red-500 text-red-700 dark:text-white rounded-lg shadow`}>
