...
interface DynamicButtonsProps {
    ...
    handleSaveEdit: () => void;
    handleOpenEditing: (roleId: number) => void;
}
...
const DynamicButtons = ({
    ...
    handleSaveEdit,
    handleOpenEditing,
}: DynamicButtonsProps): React.JSX.Element => {
    return (
        <>
...
const TableHead = ({ editingRoleId }: TableHeadProps) => {
    return (
        <thead className="">
...
const RolesTable = ({
    ...
    const handleOpenEditing = (roleId: number): void => {
